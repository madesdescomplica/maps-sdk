...
//     home: NavigationPage(
//       latitude: -5.1455761696168425, // Substitua pela latitude desejada
//       longitude: -42.78562556301317, // Substitua pela longitude desejada
//     ),
//   ));
// }

// /// Página de demonstração de navegação do Google Maps.
// /// Modificada para receber latitude e longitude como parâmetros.
...
//   // Define o modo de viagem padrão para direção (carro).
...
//       // Adiciona o waypoint inicial com as coordenadas recebidas.
//       await _addInitialWaypoint();
//     }
//   }

//   Future<void> _addInitialWaypoint() async {
//     setState(() {
//       _validRoute = false;
//     });
...
//     await _addDestinationMarker(_waypoints.last, _nextWaypointIndex);
//     await _updateNavigationDestinationsAndNavigationViewState();
//   }

//   Future<void> _addDestinationMarker(
//       NavigationWaypoint waypoint, int index) async {
//     final String title = 'Destino';
...
//       _destinationWaypointMarkers.add(addedMarkers.first!);
//     } else {
...
//     assert(_locationPermissionsAccepted,
//         'As permissões de localização devem ser concedidas');
...
//   // O restante do código permanece o mesmo, exceto pela remoção de métodos e variáveis
//   // relacionadas ao marcador de novo waypoint e interações de clique no mapa.

//   // Remova o método _onMapClicked, _updateNewWaypointMarker e _removeNewWaypointMarker
//   // e todas as referências a _newWaypointMarker.

//   // Remova também as referências aos cliques no mapa na inicialização da visualização do mapa.

//   /// O emulador iOS não atualiza a localização e não dispara eventos de roadsnapping.
//   /// Inicializa a localização do usuário para uma localização padrão se a localização do usuário
...
//     // Isso também limpará os destinos e parará a orientação
...
//   // MODIFICAÇÃO AQUI: Iniciar a navegação automaticamente após a rota ser validada
...
//         _validRoute = true;
//       });
//       // Inicia a navegação automaticamente
//       if (!_guidanceRunning) {
//         await _startGuidedNavigation();
//       }
//     }
...
//                             children: <Widget>[
//                               Text(
//                                   'Aguardando navegador e localização do usuário'),
//                               SizedBox(height: 10),
//                               SizedBox(
//                                   width: 30,
//                                   height: 30,
...
//   // MODIFICAÇÃO AQUI: Removendo o botão 'Iniciar Navegação' do widget bottomControls
...
//             ),
//           ],
//           // Removido o botão 'Iniciar Navegação'
//           if (_waypoints.isNotEmpty && _guidanceRunning)
//             Wrap(
//               alignment: WrapAlignment.center,
//               spacing: 10,
//               children: <Widget>[
